...
%Simulation of PPKTP SH efficiency curves based on BPM
...
% eps0=8.854187817e-12; 
 ...
 L=5;
 omega0=42*1e-4;
 deff=(17e-12)*3e4/(4*pi); %ppktp d33
 T=36;  %Temp scan in celsius 
 %lambda1=1.064e-4;%Pump wavelength
 lvec=(1.388:0.0001 :1.390).*1e-4;  %Can be scanned in wavelength 
 P1 =50*1e-3*1e7; % 1Watt = 1e7 erg/s  Pump power in Watt
...
Pperiod=12.5842*1e-04;
% Pperiod=16.3e-4; %Pperiod of periodic poling
%Pperiod=0.12e-5;
 ...
 MaxX=1000e-4; MaxY=1000e-4; %Pump matrix size
